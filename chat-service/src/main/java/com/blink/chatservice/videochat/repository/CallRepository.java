...
public interface CallRepository extends MongoRepository<Call, String> {
    ...
    List<Call> findByCallerIdOrReceiverIdAndStatus(String callerId, String receiverId, Call.CallStatus status);
    
    Optional<Call> findFirstByCallerIdOrReceiverIdAndStatusOrderByCreatedAtDesc(
            String callerId, String receiverId, Call.CallStatus status);
    ...
    Page<Call> findCallHistoryByUserIdAndStatus(String userId, Call.CallStatus status, Pageable pageable);
